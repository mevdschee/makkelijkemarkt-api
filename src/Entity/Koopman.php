...
class Koopman
{
     ...
     * Add dagvergunningen
     *
     * @param \App\Entity\Dagvergunning $dagvergunningen
     *
     * @return Koopman
     */
    public function addDagvergunningen(\App\Entity\Dagvergunning $dagvergunningen)
    {
     ...
     * @param \App\Entity\Dagvergunning $dagvergunningen
     */
    public function removeDagvergunningen(\App\Entity\Dagvergunning $dagvergunningen)
    {
     ...
     * Add sollicitaty
     *
     * @param \App\Entity\Sollicitatie $sollicitaty
     *
     * @return Koopman
     */
    public function addSollicitaty(\App\Entity\Sollicitatie $sollicitaty)
    {
     ...
     * @param \App\Entity\Sollicitatie $sollicitaty
     */
    public function removeSollicitaty(\App\Entity\Sollicitatie $sollicitaty)
    {
     ...
     * Add vervangersVan
     *
     * @param \App\Entity\Vervanger $vervangersVan
     *
     * @return Koopman
     */
    public function addVervangersVan(\App\Entity\Vervanger $vervangersVan)
    {
     ...
     * @param \App\Entity\Vervanger $vervangersVan
     */
    public function removeVervangersVan(\App\Entity\Vervanger $vervangersVan)
    {
     ...
     * Add vervangerVoor
     *
     * @param \App\Entity\Vervanger $vervangerVoor
     *
     * @return Koopman
     */
    public function addVervangerVoor(\App\Entity\Vervanger $vervangerVoor)
    {
     ...
     * @param \App\Entity\Vervanger $vervangerVoor
     */
    public function removeVervangerVoor(\App\Entity\Vervanger $vervangerVoor)
    {

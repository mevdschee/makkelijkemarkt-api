...
class Tariefplan
{
     ...
     * Set lineairplan
     *
     * @param \App\Entity\Lineairplan $lineairplan
     *
     * @return Tariefplan
     */
    public function setLineairplan(\App\Entity\Lineairplan $lineairplan = null)
    {
     ...
     * Set markt
     *
     * @param \App\Entity\Markt $markt
     *
     * @return Tariefplan
     */
    public function setMarkt(\App\Entity\Markt $markt)
    {
        $this->markt = $markt;
